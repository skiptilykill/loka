        ...
        if (val == 2):
            while (inside):
                ...
                if (crud == 1):
                    ...
                    p = input("Type here: ")
                    plist = [y.strip() for y in p.split(',')]
                    places.update_place(plist[0], plist[1], plist[2], plist[3],plist[4])
        ...
        if (val == 5):
            while (inside):
                ...
                if (crud == 1):
                    ...
                    print("Update social media(put it all in ONE! line, no \"):[ID] [NAME], [Page]")
                    s = input("Type here: ")
                    slist = [s.strip() for s in s.split(',')]
                    utility.add_social_media(slist[0], slist[1], slist[2])
                elif (crud == 4):
                    id = int(input("Type social media id here: "))
